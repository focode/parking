...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Add Parking', component: AddparkingPage },
      {title: 'Edit Your Parking', component: EditpagePage},
      {title: 'Search Parkings Near You', component: SearchparkingPage},
      {title: 'Your Parking History', component: HistoryofparkingPage},
